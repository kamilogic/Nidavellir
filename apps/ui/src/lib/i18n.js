...
const dict = {
  en: {
    ...
    "forge.vfElastic": "Elastic V/F ceiling supported — the undervolt is applied by flattening the curve (Afterburner-style), keeping the GPU's power-management elasticity.",
  ...
  pt: {
    ...
    "forge.vfElastic": "Teto V/F elástico suportado — o undervolt é aplicado achatando a curva (estilo Afterburner), mantendo a elasticidade de gestão de energia da GPU.",
